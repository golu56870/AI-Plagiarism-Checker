...
const DECK_ID = "test-readable-core-story";
const OUT_DIR = "E:\\golu\\outputs\\test-readable-deck";
const REF_DIR = "E:\\golu\\outputs\\test-readable-deck\\refs";
...
const SOURCES = {
  primary: 'Recovered text from test-readable.pdf: "Academic integrity requires students to cite sources accurately."',
};

const SLIDES = [
  {
    "kicker": "SOURCE SUMMARY",
    "title": "Academic Integrity Depends on Accurate Citation",
    "subtitle": "The source reduces the issue to a clear standard: students are expected to cite sources accurately.",
    "expectedVisual": "Editorial cover slide with a strong title, concise framing, and a core-idea callout.",
    "moment": "Accurate citation is the baseline requirement.",
    "notes": "Open with the exact source sentence and frame the rest of the deck as an interpretation of that requirement.",
    "sources": [
      "primary"
    ]
  },
  {
    "kicker": "CORE STORY",
    "title": "The source defines both the principle and the expected behavior",
    "subtitle": "It links academic integrity to a specific action: citing sources accurately, not vaguely or optionally.",
    "expectedVisual": "Three aligned cards summarizing the principle, the actor, and the required action.",
    "cards": [
      [
        "Principle",
        "Academic integrity is presented as something that must be protected through everyday scholarly behavior."
      ],
      [
        "Actor",
        "Students are explicitly named, making responsibility clear rather than implied."
      ],
      [
        "Behavior",
        "The required behavior is accurate citation, which makes source use traceable and verifiable."
      ]
    ],
    "notes": "Emphasize that the wording does not just celebrate integrity as a value; it ties integrity to a concrete practice.",
    "sources": [
      "primary"
    ]
  },
  {
    "kicker": "EVIDENCE AND DECISION",
    "title": "The wording is brief, but it supports a firm decision",
    "subtitle": "Each part of the sentence contributes evidence about what must be enforced and why.",
    "expectedVisual": "Three evidence cards highlighting the standard, accountability, and performance threshold.",
    "metrics": [
      [
        "Integrity",
        "Standard being protected",
        "The sentence anchors the issue in an ethical and academic norm."
      ],
      [
        "Students",
        "Who must act",
        "Responsibility is assigned directly rather than left to interpretation."
      ],
      [
        "Accurately",
        "How the action must be done",
        "The modifier raises the bar from citing at all to citing correctly."
      ]
    ],
    "notes": "Translate the evidence into a decision: treat citation accuracy as a required standard, not a best-effort suggestion.",
    "sources": [
      "primary"
    ]
  },
  {
    "kicker": "NEXT STEPS",
    "title": "Turn the standard into clear teaching and review practices",
    "subtitle": "If accurate citation is the requirement, teams should make the expectation visible, teachable, and checkable.",
    "expectedVisual": "Three action cards focused on policy clarity, instruction, and review checkpoints.",
    "cards": [
      [
        "Clarify",
        "State citation expectations plainly in assignment briefs, rubrics, and academic integrity guidance."
      ],
      [
        "Teach",
        "Show students what accurate citation looks like through examples, models, and quick-reference guidance."
      ],
      [
        "Check",
        "Build review steps that catch missing, incomplete, or incorrect attribution before final submission."
      ]
    ],
    "notes": "Close by reinforcing that the requirement is simple, but consistent operational follow-through is what makes it effective.",
    "sources": [
      "primary"
    ]
  }
...
async function verifyAndExport(presentation) {
  ...
  const pptxPath = path.join(OUT_DIR, "test-readable-core-story-deck.pptx");
